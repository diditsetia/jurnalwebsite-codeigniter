...
//shwo 
	...
	if(sl('k').src=="http://arabic-keyboard.eu/images/keyboard.png"){
...
function los(el){
 ...
 if(el=="back"){
	...
	MeinFenster = window.open("http://www.bing.com/search?q="+encode);
  }
  else if(el=="google"){  


	MeinFenster = window.open("http://www.google.de/search?hl=de&q="+encode);
   }
    else if(el=="ssg"){
	MeinFenster = window.open("http://www.arabic-keyboard.eu/search/?cx=partner-pub-015260852779373050421%3Achjry2-kwko&cof=FORID%3A9&ie=UTF-8&q="+sl('ssg').firstChild.nodeValue);
   }
    else if(el=="youtube"){
...
case "a": tip = " # = ? / a = &#1575; / a' = &#1571; / A = &#1573;  ";break;
case "b": tip = " p = &#1576;  ";break;
case "c": tip = " s = &#1587;  /  ss = &#1579; ";break;
case "h": tip = " 7' = ?   /  x = ?  / H = ? ";break;
case "7": tip = " 7' = ?    ";break;
...
/* This code shares the page it is on. TODO: add option to share another page. */
  function email(){
    var link = document.getElementById('share1');
    var text = document.getElementById('textarea1');
    var textStepTwo = text.value;
    var email = "mailto:?subject=";
    var emailtxt = "&body=";
    var subject = document.getElementById('subject').value;
    var sharetxt = encodeURIComponent(textStepTwo);
    link.href = email + subject + emailtxt + sharetxt + "%20" + document.URL;  
  }
  function twitterShare(){
    var link = document.getElementById('share2');
    var text = document.getElementById('textarea2');
    var textStepTwo = text.value;
    var twitter = "https://twitter.com/share?url=";
    var sharetxt = encodeURIComponent(textStepTwo);
    link.href = twitter + document.URL + "&text=" + sharetxt;  
  }
