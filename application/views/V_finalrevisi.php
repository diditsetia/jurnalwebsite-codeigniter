           ...
           <div class="row">
            <div class="col-lg-12">
                <h4 style="color: #77c7c3">Save Revisi</h4>
            </div>
        </div>
        <hr>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <thead>
                ...
                <?php foreach ($finalrevisi as $key ) { ?>
                  <tbody> 
                   ...
                   <td><?php echo $key['status']; ?></td>
                    ...
                    <?php if (  $key['status'] == 'revisifinal' && $key['kolom'] ==  '1' ) { ?>
                      ...
                      <a href="<?php echo site_url('web/editrevisi').'/'.$key['id_artikel']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
                    <?php } elseif ($key['status'] == 'waitingfinal' && $key['kolom'] == '1' ) { ?>
                      <a href="<?php echo site_url('pratinjau/juduljurnal1').'/'.$key['id_artikel']; ?>"><span class="glyphicon glyphicon-eye-open"></span></a>
                    <?php }elseif ($key['status'] == 'siappost' && $key['kolom'] == '1' ) { ?>
                      <a href="<?php echo site_url('web/hapusartikelpenulis').'/'.$key['id_artikel']; ?>" ><span class="glyphicon glyphicon-trash"></span></a>
                      <a href="<?php echo site_url('web/editrevisi').'/'.$key['id_artikel']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
                    <?php } ?>
