 ...
 <div class="container" >
           ...
           <div class="row">
            <div class="col-lg-12">
                <h4 style="color: #77c7c3">Dashboard Reviewer</h4>
            </div>
        </div>
        <hr>
                  ...
                  <tbody> 
                   ...
                   <td><?php echo $key['nama_penulis']; ?></td>
                    ...
                    <?php }elseif ($key['status'] == 'waitingfinal' && $key['kolom'] == '1') { ?>
                     ...
                     <a href="<?php echo site_url('review/juduljurnal1').'/'.$key['id_artikel']; ?>"><span class="glyphicon glyphicon-eye-open"></span></a>
                      <?php if( $key['uraianperbaikan'] != NULL) { ?>
                        <a href="<?php echo site_url('web/siappost').'/'.$key['id_artikel']; ?>"><span class="glyphicon glyphicon-level-up"></span></a>
                         <a href="<?php echo site_url('web/revisilagi').'/'.$key['id_artikel']; ?>"><span class="glyphicon glyphicon-edit"></span></a>
                      <?php } ?>
                    <?php }  ?>
