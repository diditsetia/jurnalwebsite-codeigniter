        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" >
                    <img src="<?php echo base_url('assets/img/logosip.png'); ?>" alt="" width="150" hight="50" style="padding-top: 7px;border-left-width: 20px;margin-left: 20px;">
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                     ...
                     <li>
                         <a><span class="glyphicon glyphicon-th"></span></a>
                    </li>
                    ...
                    <li>
                         <a><span class="glyphicon glyphicon-log-out"></span></a>
                    </li>
