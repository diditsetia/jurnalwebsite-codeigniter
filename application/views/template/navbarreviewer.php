        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">
                    <img src="<?php echo base_url('assets/img/logosip.png') ?>" alt="" width="150" hight="50" style="padding-top: 8px;border-left-width: 20px;margin-left: 30px;">
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                     ...
                     <li>
                         <a href="<?php echo site_url('web/riviewer'); ?>"><span class="glyphicon glyphicon-th"></span></a>
                    </li>
