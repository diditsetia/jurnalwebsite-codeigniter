  ...
  <section id="" class="column">
    ...
    <article class="module width_full">
      ...
      <div class="submit_link_back">
        <input type="submit" value="< Penutup" class="alt_btn" onClick="parent.location='<?php echo site_url('pratinjaunodb/penutup1')  ?>'" >
      </div>
        ...
        $session_id = $this->session->userdata('status') == 'post' ) { ?>
          ...
          <div class="col-lg-12" align="right" >
            ...
            <div class="MsoNormal" >
               ...
               <?php 
             echo $session_id = $this->session->userdata('daftarpustaka');
