  ...
  <section id="" class="column">
    ...
    <article class="module width_full">
      ...
      <div class="submit_link_back">
        <input type="submit" value="< Landasan teori" class="alt_btn" onClick="parent.location='<?php echo site_url('pratinjaunodb/landasanteori1') ?>'" >
      </div>
         ...
         <?php if ( $session_id = $this->session->userdata('status') == 'Waiting' && 
          ...
          <div class="col-lg-12" align="right" >
            ...
            <div class="MsoNormal" >
               ...
               <?php 
            echo $session_id = $this->session->userdata('metodepenelitian');
