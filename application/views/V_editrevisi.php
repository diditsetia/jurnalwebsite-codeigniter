<div class="container" >
        ...
        <div class="row">
            <div class="col-lg-12">
                <h4 style="color: #56bca6">Edit Revisi</h4>
            </div>
        </div>
        <!-- /.row -->

        <hr>
        <?php foreach ($dataeditrevisi as $key ) { ?>
        ...
        <form  enctype='multipart/form-data' class="form-horizontal" action="<?php echo site_url('Updatejurnal/update'); ?>" method="post">
         ...
         <div  class="col-sm-2 ">
              ...
              <button type="submit" name="submit" value="pratinjaurevisi" class="btn btn-info" style="width:100%">pratinjau</button>
        </div>
        <?php if ($key->status == 'revisifinal') { ?>
          <div class="col-sm-1">
        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModalsend">send</button>
        </div>
        <?php } ?>

        <?php if ($key->status == 'siappost') { ?>
         <div class="col-sm-1">
          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModalredaksi">send</button>
        </div>
        <?php } ?>
  ...
  <!-- Tombol untuk menampilkan modal-->
   ...
   <!-- Modal send ke redaksi -->
   <div id="myModalredaksi" class="modal fade" role="dialog">
   ...
   <div id="myModalsend" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
        <div class="col-sm-2">
        <button type="submit" name="submit" value="sendrevisifinal" class="btn btn-info" style="width:100%">Send</button>
      </div>
        <!--<div class="col-sm-6">
        <button type="submit" name="submit" value="sendupdate2" class="btn btn-info" style="width:100%">2 kolom</button>
      </div> -->
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <?php if ($querysave->status == 'revisi') { ?>
            <div class="radio">
           <label>
           <input type="radio" name="status"  value="revisi" checked >
            revisi
            </label>
            <label>
             <input type="radio" name="status" value="revisifinal">
             revisi final
            </label>
            </div>
          <?php }elseif ($querysave->status =='revisifinal') { ?>
             <div class="radio">
           <label>
           <input type="radio" name="status"  value="revisi" >
            ...
            <label>
             <input type="radio" name="status" value="revisifinal" checked >
             revisi final
            </label>
            </div>
          <?php } ?>
        ...
        <div >
        <button type="submit" name="submit" value="saveupdaterevisi1" class="btn btn-info" style="width:20%"> Save</button>
        <button type="submit" name="submit" value="saveupdaterevisi2" class="btn btn-info" style="width:20%"> Save as</button>
      </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <button type="submit" name="submit" value="cancel" class="btn btn-info" style="width:100%">Tutup</button>
              ...
              <div class="form-group">
              <label for="exampleTextarea" class="col-sm-2 control-label">Pesan Revisi</label>
              <div class="col-sm-10">
              <textarea readonly class="form-control " name="uraian" style="margin: 0px -1px 0px 0px; height: 243px; width: 945px;" >
              <?php echo ($this->session->userdata('uraian') == '') ? $key->uraianperbaikan : $this->session->userdata('uraian'); ?></textarea>
              </div>
            </div>
