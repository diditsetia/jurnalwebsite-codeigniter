  ...
  <section id="" class="column">
    ...
    <article class="module width_full">
      ...
      <div class="submit_link">
          <input type="submit" value="Daftar Pustaka >" class="alt_btn" onClick="parent.location='<?php echo site_url('baca/daftarpustaka1').'/'.$datajurnal->id_artikel; ?>'" >
        </div>
      <div class="submit_link_back">
        <input type="submit" value="< Pembahasan" onClick="parent.location='<?php echo site_url('baca/pembahasan1').'/'.$datajurnal->id_artikel; ?>'" >
      </div>
