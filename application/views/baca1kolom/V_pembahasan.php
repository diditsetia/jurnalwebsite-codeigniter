  ...
  <section id="" class="column">
    ...
    <article class="module width_full">
      ...
      <div class="submit_link">
          <input type="submit" value="Penutup > " class="alt_btn" onClick="parent.location='<?php echo site_url('baca/penutup1').'/'.$datajurnal->id_artikel; ?>'" >
        </div>
      <div class="submit_link_back">
        <input type="submit" value=" < Metode Penelitian" onClick="parent.location='<?php echo site_url('baca/metodepenelitian1').'/'.$datajurnal->id_artikel; ?>'">
      </div>
