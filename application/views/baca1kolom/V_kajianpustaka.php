  ...
  <section id="" class="column">
    ...
    <article class="module width_full">
      ...
      <div class="submit_link">
          <input type="submit" value="Landasan Teori > " class="alt_btn" onClick="parent.location='<?php echo site_url('baca/landasanteori1').'/'.$datajurnal->id_artikel; ?>'" >
        </div>
      <div class="submit_link_back">
        <input type="submit" value=" < Pendahuluan" onClick="parent.location='<?php echo site_url('baca/pendahuluan1').'/'.$datajurnal->id_artikel; ?>'" >
      </div>
